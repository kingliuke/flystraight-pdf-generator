...
Changes from v2:
  - Added BOX_INVESTMENT tag: dedicated value stacking renderer with
    large centred investment amount and visual hierarchy
  - Added footer branding: "FLY STRAIGHT TRANSFORMATION" on every page
  - Increased H3 spaceBefore from 10 to 20 for option header breathing room
  - H4 style and handler retained from v2
  - Bullet/dash strip in callout_box retained from v2
"""
