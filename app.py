...
def generate_pdf():
    ...
    try:
        ...
        print(f"First 300 chars: {repr(markdown_content[:300])}")
        print(f"Last 300 chars: {repr(markdown_content[-300:])}")
        ...
        print(f"APPENDIX_START position: {markdown_content.find('[APPENDIX_START]')}")
        print(f"=== END DEBUG ===")
